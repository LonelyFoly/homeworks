...
namespace Tanks
{
    public partial class Form1 : Form
    {
        ...
        {
            int[][] a = game.Draw();
            pictureBox_Enemy.BackgroundImage = game.im1;
            pictureBox_Player.BackgroundImage = game.im2;
            pictureBox_Enemy.Location = new Point(a[0][0],a[0][1]);
            pictureBox_Player.Location = new Point(a[1][0], a[1][1]);
